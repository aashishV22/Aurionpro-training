...
public class AccountTest 
{
	public static void main(String[] args) 
	{
		...
		//Account[] accountDetails=new Account[4];
		Account[] accountDetails={new Account(1,"Aashish",4000,AccountType.SAVING),
								new Account(2,"vedang",464000,AccountType.CURRENT),
								new Account(3,"Ansh",4500,AccountType.CURRENT),
								new Account(4,"Aashish",400,AccountType.SAVING),
				};
...
//		for(int i=0;i<4;i++) 
//		{
//			accountDetails[i]=new Account();
//			setAccountDetails(accountDetails[i]);
//		}
		Account highestBalanceAccount=findHighestBalance(accountDetails);
		System.out.println("The highest balance account is "+highestBalanceAccount);
