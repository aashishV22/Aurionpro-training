...
<h2 class ="container">Deposit Amount</h2>
<br><br>
 ...
 --%>	
	...
	<form action="singleUserController" >
		...
		<input type="hidden" name="transactioType_id" value="300">
 		<input type="number" placeholder="Enter Ammout to deposit" name="amount" required>
		<button type="submit" class="btn btn-secondary">Deposit </a>	
	</form>
	</td>
	</tr>
</table>
