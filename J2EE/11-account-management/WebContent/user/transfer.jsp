...
<h2 class ="container">Transfer Amount</h2>
<br><br>
 ...
 --%>	
	...
	<form action="singleUserController" >
		...
		<input type="hidden" name="transactioType_id" value="300">
 		<input type="number" name="receiversAccountNumber" placeholder="Enter Account Number" required>
 		<input type="number" name="amount" placeholder="Enter Ammout to Transfer" required>
		<button type="submit" class="btn btn-secondary">Transfer </a>	
	</form>
	</td>
	</tr>
</table>
...
<script type="text/javascript" src="user/transfer.js"></script>
</body>
</html>